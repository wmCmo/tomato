        ...
        <div className="flex justify-center">
            <div className='text-accent bg-extreme p-8 rounded-xl flex flex-col gap-8 max-w-96 border border-border'>
                <div className="flex flex-col items-center gap-2">
                    ...
                    <h1 className='font-bold text-2xl text-center'>Let's sign you in!</h1>
                </div>
                <div className="flex justify-center">
                    <button onClick={signInWithGoogle} className='bg-background rounded-md flex px-6 py-3 gap-4 items-center'>
