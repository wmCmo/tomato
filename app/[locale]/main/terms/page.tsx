...
export default async function TermsOfUse({ params }: { params: Promise<{ locale: LocaleType; }>; }) {
    const { locale: localeTag } = await params;
    const locale = translation[localeTag];
    ...
    return (
        <div className="text-accent mt-10 leading-6 pb-8 px-4 flex flex-col items-center">
            ...
            <ol id="policy" className="scroll-mt-64 list-decimal list-inside marker:font-bold space-y-8 mt-8 mb-20 max-w-lg">
                ...
                <li className="space-y-2">
                    ...
                    <ul className="space-y-2">
                        <li><b>Email:</b> <code className="inline-code"><CopyButton text="titan.zp4@gmail.com">titan.zp4@gmail.com</CopyButton></code></li>
            ...
            <div className="sticky top-10 bg-background px-4 pt-8 min-h-48 w-full max-w-lg">
                <Link href={`/${localeTag}/main/terms#terms`}>
            ...
            <ol id="terms" className="scroll-mt-64 list-decimal list-inside marker:font-bold space-y-8 mt-8 px-4 max-w-lg">
                <li className="space-y-2">
